...
Diri's original source is licensed under the repository's [Apache-2.0 license](../../LICENSE). Distributed builds also include third-party dependencies governed by
their own terms.

- [GPL-3.0-or-later](GPL-3.0-or-later.txt) is included for Zed packages conservatively treated
